...
/obj/machinery/smartfridge/bottlerack/alchemy_rack/accept_check(obj/item/O)
	if(istype(O, /obj/item/reagent_containers/pill/patch) || istype(O, /obj/item/reagent_containers/glass/bottle/primitive) || istype(O, /obj/item/stack/medical/mourning_dust) || istype(O, /obj/item/smelling_salts))
		return TRUE
	return FALSE
