...
/obj/machinery/mineral/wasteland_vendor/ingredients
	name = "Vending Machine - Ingredients"
	icon = 'icons/WVM/new_vendors.dmi'
	icon_state = "generic_idle"
	prize_list = list(
		new /datum/data/wasteland_equipment("Randomized Bundle",		/obj/item/storage/box/ingredients/wildcard,						30),
		new /datum/data/wasteland_equipment("Fiesta Bundle",			/obj/item/storage/box/ingredients/fiesta,						30),
		new /datum/data/wasteland_equipment("Italian Bundle",			/obj/item/storage/box/ingredients/italian,						50),
		new /datum/data/wasteland_equipment("Vegetarian Bundle",		/obj/item/storage/box/ingredients/vegetarian,					30),
		new /datum/data/wasteland_equipment("American Bundle",			/obj/item/storage/box/ingredients/american,						40),
		new /datum/data/wasteland_equipment("Fruit Bundle",				/obj/item/storage/box/ingredients/fruity,						30),
		new /datum/data/wasteland_equipment("Sweets Bundle",			/obj/item/storage/box/ingredients/sweets,						30),
		new /datum/data/wasteland_equipment("Grains Bundle",			/obj/item/storage/box/ingredients/grains,						30),
		new /datum/data/wasteland_equipment("Carnivore Bundle",			/obj/item/storage/box/ingredients/carnivore,					60),
		new /datum/data/wasteland_equipment("Exotic Bundle",			/obj/item/storage/box/ingredients/exotic,						30),
		new /datum/data/wasteland_equipment("Sushi Bundle",				/obj/item/storage/box/ingredients/sushi,						50),
		new /datum/data/wasteland_equipment("Flour Sack",				/obj/item/reagent_containers/food/condiment/flour,				10),
		new /datum/data/wasteland_equipment("Milk",						/obj/item/reagent_containers/food/condiment/milk,				10),
		new /datum/data/wasteland_equipment("Soymilk",					/obj/item/reagent_containers/food/condiment/soymilk,			10),
		new /datum/data/wasteland_equipment("Universal Enzyme",			/obj/item/reagent_containers/food/condiment/enzyme,				20),
		new /datum/data/wasteland_equipment("Rice Sack",				/obj/item/reagent_containers/food/condiment/rice,				10),
		new /datum/data/wasteland_equipment("Soy Sauce",				/obj/item/reagent_containers/food/condiment/soysauce,			10),
		new /datum/data/wasteland_equipment("Mayonnaise",				/obj/item/reagent_containers/food/condiment/mayonnaise,			10),
		new /datum/data/wasteland_equipment("Ketchup",					/obj/item/reagent_containers/food/condiment/ketchup,			10),
		new /datum/data/wasteland_equipment("Mustard",					/obj/item/reagent_containers/food/condiment/mustardbottle,		10),
		new /datum/data/wasteland_equipment("BBQ sauce",				/obj/item/reagent_containers/food/condiment/bbqsauce,			10),
		new /datum/data/wasteland_equipment("Salt Shaker",				/obj/item/reagent_containers/food/condiment/saltshaker,			5),
		new /datum/data/wasteland_equipment("Pepper Mill",				/obj/item/reagent_containers/food/condiment/peppermill,			5),
		new /datum/data/wasteland_equipment("Meat",						/obj/item/reagent_containers/food/snacks/meat/slab,				12),
		new /datum/data/wasteland_equipment("Chicken Meat",				/obj/item/reagent_containers/food/snacks/meat/slab/chicken,		12),
		new /datum/data/wasteland_equipment("Egg Carton",				/obj/item/storage/fancy/egg_box,								24),
		new /datum/data/wasteland_equipment("Apple",					/obj/item/reagent_containers/food/snacks/grown/apple,			7),
		new /datum/data/wasteland_equipment("Banana",					/obj/item/reagent_containers/food/snacks/grown/banana,			7),
		new /datum/data/wasteland_equipment("Soy Beans",				/obj/item/reagent_containers/food/snacks/grown/soybeans,		7),
		new /datum/data/wasteland_equipment("Berries",					/obj/item/reagent_containers/food/snacks/grown/berries,			7),
		new /datum/data/wasteland_equipment("Cabbage",					/obj/item/reagent_containers/food/snacks/grown/cabbage,			7),
		new /datum/data/wasteland_equipment("Carrot",					/obj/item/reagent_containers/food/snacks/grown/carrot,			7),
		new /datum/data/wasteland_equipment("Cherries",					/obj/item/reagent_containers/food/snacks/grown/cherries,		7),
		new /datum/data/wasteland_equipment("Chili",					/obj/item/reagent_containers/food/snacks/grown/chili,			7),
		new /datum/data/wasteland_equipment("Corn",						/obj/item/reagent_containers/food/snacks/grown/corn,			7),
		new /datum/data/wasteland_equipment("Eggplant",					/obj/item/reagent_containers/food/snacks/grown/eggplant,		7),
		new /datum/data/wasteland_equipment("Garlic",					/obj/item/reagent_containers/food/snacks/grown/garlic,			7),
		new /datum/data/wasteland_equipment("Grape",					/obj/item/reagent_containers/food/snacks/grown/grapes,			7),
		new /datum/data/wasteland_equipment("Herbs",					/obj/item/reagent_containers/food/snacks/grown/herbs,			7),
		new /datum/data/wasteland_equipment("Lemon",					/obj/item/reagent_containers/food/snacks/grown/citrus/lemon,	7),
		new /datum/data/wasteland_equipment("Lime",						/obj/item/reagent_containers/food/snacks/grown/citrus/lime,		7),
		new /datum/data/wasteland_equipment("Watermelon",				/obj/item/reagent_containers/food/snacks/grown/watermelon,		7),
		new /datum/data/wasteland_equipment("Onion",					/obj/item/reagent_containers/food/snacks/grown/onion,			7),
		new /datum/data/wasteland_equipment("Orange",					/obj/item/reagent_containers/food/snacks/grown/citrus/orange,	7),
		new /datum/data/wasteland_equipment("Potato",					/obj/item/reagent_containers/food/snacks/grown/potato,			7),
		new /datum/data/wasteland_equipment("Strawberry",				/obj/item/reagent_containers/food/snacks/grown/strawberry,		7),
		new /datum/data/wasteland_equipment("Tomato",					/obj/item/reagent_containers/food/snacks/grown/tomato,			7)
	)
	highpop_list = list(
		new /datum/data/wasteland_equipment("Randomized Bundle",		/obj/item/storage/box/ingredients/wildcard,						30),
		new /datum/data/wasteland_equipment("Fiesta Bundle",			/obj/item/storage/box/ingredients/fiesta,						30),
...
/obj/machinery/mineral/wasteland_vendor/scrap
	name = "Wasteland Vending Machine - Scrap"
	icon = 'icons/WVM/new_vendors.dmi'
	icon_state = "seller_crafting"
	prize_list = list(
		new /datum/data/wasteland_equipment("Pre-war salvage",				/obj/item/salvage/low,											40),
		new /datum/data/wasteland_equipment("Pre-war tool salvage",			/obj/item/salvage/tool,											60),
		new /datum/data/wasteland_equipment("Advanced pre-war salvage",		/obj/item/salvage/high,											80)
		)
	highpop_list = list(
		new /datum/data/wasteland_equipment("Pre-war salvage",				/obj/item/salvage/low,											60),
		new /datum/data/wasteland_equipment("Pre-war tool salvage",			/obj/item/salvage/tool,											70),
		new /datum/data/wasteland_equipment("Advanced pre-war salvage",		/obj/item/salvage/high,											100)
		)
