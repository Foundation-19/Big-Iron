...
/obj/item/clothing/head/helmet/f13/enclave/marine
	...
	flags_cover = HEADCOVERSEYES | HEADCOVERSMOUTH
	armor = list("melee" = 45, "bullet" = 45, "laser" = 45, "energy" = 35, "bomb" = 55, "bio" = 60, "rad" = 10, "fire" = 60, "acid" = 20, "wound" = 55)
...
/obj/item/clothing/head/helmet/f13/legion/recruit
	...
	armor = list("melee" = 40, "bullet" = 20, "laser" = 15, "energy" = 10, "bomb" = 20, "bio" = 20, "rad" = 20, "fire" = 25, "acid" = 0, "wound" = 40)
	flags_inv = HIDEEARS|HIDEHAIR
...
/obj/item/clothing/head/helmet/f13/legion/venator
	...
	armor = list("melee" = 40, "bullet" = 30, "laser" = 20, "energy" = 10, "bomb" = 20, "bio" = 20, "rad" = 20, "fire" = 25, "acid" = 0, "wound" = 40)
	salvage_loot = list(/obj/item/stack/crafting/armor_plate = 2)
...
/obj/item/clothing/head/helmet/f13/legion/prime/decan
	...
	armor = list("melee" = 55, "bullet" = 40, "laser" = 20, "energy" = 10, "bomb" = 20, "bio" = 20, "rad" = 20, "fire" = 25, "acid" = 0, "wound" = 40)
...
/obj/item/clothing/head/helmet/f13/legion/heavy
	...
	armor = list("melee" = 60, "bullet" = 45, "laser" = 25, "energy" = 20, "bomb" = 35, "bio" = 50, "rad" = 20, "fire" = 70, "acid" = 0, "wound" = 50)
...
/obj/item/clothing/head/helmet/f13/legion/vet/decan
	...
	armor = list("melee" = 55, "bullet" = 40, "laser" = 20, "energy" = 15, "bomb" = 25, "bio" = 50, "rad" = 20, "fire" = 70, "acid" = 0, "wound" = 50)
...
/obj/item/clothing/head/helmet/f13/legion/centurion
	...
	armor = list("melee" = 75, "bullet" = 55, "laser" = 30, "energy" = 25, "bomb" = 45, "bio" = 20, "rad" = 20, "fire" = 45, "acid" = 45, "wound" = 55)
	resistance_flags = LAVA_PROOF | FIRE_PROOF
...
/obj/item/clothing/head/helmet/f13/legion/rangercent
	...
	armor = list("melee" = 45, "bullet" = 60, "laser" = 30, "energy" = 25, "bomb" = 35, "bio" = 60, "rad" = 20, "fire" = 80, "acid" = 0, "wound" = 55)
	resistance_flags = LAVA_PROOF | FIRE_PROOF
	salvage_loot = list(/obj/item/stack/crafting/armor_plate = 3)
...
/obj/item/clothing/head/helmet/f13/legion/palacent
	...
	armor = list("melee" = 35, "bullet" = 60, "laser" = 40, "energy" = 35, "bomb" = 35, "bio" = 20, "rad" = 20, "fire" = 25, "acid" = 0, "wound" = 75)
	resistance_flags = LAVA_PROOF | FIRE_PROOF
	salvage_loot = list(/obj/item/stack/crafting/armor_plate = 3)
...
/obj/item/clothing/head/beret/ncr
	...
	armor = list("melee" = 35, "bullet" = 40, "laser" = 25, "energy" = 20, "bomb" = 50, "bio" = 30, "rad" = 20, "fire" = 60, "acid" = 0, "wound" = 40)
