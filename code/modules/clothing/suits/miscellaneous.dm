...
/obj/item/clothing/suit/hooded/robes/cotc
	...
	armor = list("melee" = 5, "bullet" = 15, "laser" = 10, "energy" = 10, "bomb" = 6, "bio" = 14, "rad" = 0, "fire" = 0, "acid" = 5, "wound" = 20)
...
/obj/item/clothing/suit/hooded/robes/cotc/acolyte
	...
	armor = list("melee" = 5, "bullet" = 15, "laser" = 10, "energy" = 10, "bomb" = 15, "bio" = 10, "rad" = 0, "fire" = 0, "acid" = 5, "wound" = 25)
...
/obj/item/clothing/suit/hooded/robes/cotc/proselytizer
	...
	armor = list("melee" = 5, "bullet" = 25, "laser" = 15, "energy" = 15, "bomb" = 10, "bio" = 10, "rad" = 0, "fire" = 0, "acid" = 5, "wound" = 30)
...
/obj/item/clothing/suit/hooded/robes/cotc/servitor
	...
	armor = list("melee" = 10, "bullet" = 20, "laser" = 10, "energy" = 10, "bomb" = 15, "bio" = 10, "rad" = 0, "fire" = 0, "acid" = 5, "wound" = 35)
...
/obj/item/clothing/suit/hooded/robes/cotc/highpriest
	...
	armor = list("melee" = 10, "bullet" = 20, "laser" = 10, "energy" = 10, "bomb" = 15, "bio" = 10, "rad" = 0, "fire" = 20, "acid" = 5, "wound" = 40) // equal to legion recruit wounding protection
...
/obj/item/clothing/head/hooded/robes/cotc/highpriest
	...
	icon_state = "highpriest"
	armor = list("melee" = 10, "bullet" = 20, "laser" = 10, "energy" = 10, "bomb" = 15, "bio" = 10, "rad" = 0, "fire" = 20, "acid" = 5, "wound" = 40)
