...
/obj/item/encryptionkey/headset_blackwater
	name = "Blackwater radio encryption key"
	desc = "An encryption key for a radio headset.  To access the Blackwater channel, use :h."
	icon_state = "cypherkey"
	channels = list(RADIO_CHANNEL_BLACKWATER = 1)
