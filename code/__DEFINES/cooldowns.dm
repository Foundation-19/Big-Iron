...
#define TIMER_COOLDOWN_START(cd_source, cd_index, cd_time) LAZYSET(cd_source.cooldowns, cd_index, addtimer(CALLBACK(GLOBAL_PROC,PROC_REF(end_cooldown), cd_source, cd_index), cd_time))
...
#define S_TIMER_COOLDOWN_START(cd_source, cd_index, cd_time) LAZYSET(cd_source.cooldowns, cd_index, addtimer(CALLBACK(GLOBAL_PROC,PROC_REF(end_cooldown), cd_source, cd_index), cd_time, TIMER_STOPPABLE))
