...
#define FACTION_RUSTWALKER "Rustwalkers"
...
GLOBAL_LIST_INIT(faction_list, list(FACTION_NCR, FACTION_LEGION, FACTION_BROTHERHOOD, FACTION_KEBAB, FACTION_ENCLAVE, FACTION_WASTELAND, FACTION_RAIDERS, FACTION_MERCHANT, FACTION_CHURCH, FACTION_RUSTWALKERS))
