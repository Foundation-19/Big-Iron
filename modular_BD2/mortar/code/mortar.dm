/obj/structure/mortar
	...
	icon = 'modular_BD2/mortar/icons/mortar.dmi'
...
*/
		...
		playsound(loc, 'modular_BD2/mortar/sound/mortar_reload.ogg', 50, 1)
		busy = 1
		...
		if(do_after(user, 15, src))
			...
			playsound(loc, 'modular_BD2/mortar/sound/mortar_fire.ogg', 50, 1)
			busy = 0
			firing = 1
...
/obj/item/mortar_kit/attack_self(mob/user)
	...
	playsound(loc, 'modular_BD2/mortar/sound/mortar_unpack.ogg', 25, 1)
	if(do_after(user, 40, src))
